...
-- Dump completed on 2025-11-12 12:20:22
-- MySQL dump 10.13  Distrib 8.0.41, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: batch982
-- ------------------------------------------------------
-- Server version	8.0.41
...
--
-- Temporary view structure for view `indian_customers`
--

DROP TABLE IF EXISTS `indian_customers`;
/*!50001 DROP VIEW IF EXISTS `indian_customers`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `indian_customers` AS SELECT 
 1 AS `customer_id`,
 1 AS `first_name`,
 1 AS `last_name`,
 1 AS `address`*/;
...
--
-- Final view structure for view `indian_customers`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `indian_customers` AS select `c`.`customer_id` AS `customer_id`,`c`.`first_name` AS `first_name`,`c`.`last_name` AS `last_name`,`a`.`address` AS `address` from (((`customer` `c` join `address` `a` on((`c`.`address_id` = `a`.`address_id`))) join `city` `ct` on((`a`.`city_id` = `ct`.`city_id`))) join `country` `co` on((`ct`.`country_id` = `co`.`country_id`))) where (`co`.`country` = 'India') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-11-12 12:20:23
-- MySQL dump 10.13  Distrib 8.0.41, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: sales_demo
-- ------------------------------------------------------
-- Server version	8.0.41
...
-- MySQL dump 10.13  Distrib 8.0.41, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: sample_sales_data
-- ------------------------------------------------------
-- Server version	8.0.41
...
--
-- Table structure for table `sample_sales_data`
--

DROP TABLE IF EXISTS `sample_sales_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
-- Dump completed on 2025-11-12 12:20:24
-- MySQL dump 10.13  Distrib 8.0.41, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: bikestore
-- ------------------------------------------------------
-- Server version	8.0.41
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`staff_id`) REFERENCES `staffs` (`staff_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stocks` (
  ...
  KEY `product_id` (`product_id`),
  CONSTRAINT `stocks_ibfk_1` FOREIGN KEY (`store_id`) REFERENCES `stores` (`store_id`),
  CONSTRAINT `stocks_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
